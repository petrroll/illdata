...
const en: Translations = {
    ...
    aboutNlInfectieradarFrequency: 'Weekly (about a two-week laboratory delay)',
...
const cs: Translations = {
    ...
    aboutNlInfectieradarFrequency: 'Týdně (laboratorní výsledky mají přibližně dvoutýdenní zpoždění)',
